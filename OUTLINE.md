...
2. System Architecture Overview
   - Two-tiered application structure:
     - Data Processing and Storage Application (ragger_data.py): Handles document ingestion, parsing, indexing, and storage
     - AI Interaction Application (ragger.py): Processes user queries and generates responses using retrieved context
   ...
   - Configuration Management:
     ...
     - User global configuration file (dot file)
     - Per project configuration file (like Google Gemini)
...
3. Data Loader Application (Document Processing Component)
   ...
   - Storage and Indexing:
     ...
     - Traditional database storage (such as SQLite) for document metadata and structure
...
4. AI Interaction Application (Query Processing Component)
   - Query Processing:
     ...
     - Create sub-agent for web searches
   ...
   - Generation Capabilities:
     - Integration with language models (Llama, GPT, or local engines such as Ollama or Llama.cpp)
...
5. Technical Implementation Details
   - Core Libraries and Frameworks:
     ...
     - Data Management: SQLite, or MongoDB
